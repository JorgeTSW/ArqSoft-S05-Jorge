...
namespace CitasApp.Infrastructure.Repositories
{
    public class PostgresCitaRepository : ICitaRepository
    {
        ...
        public PostgresCitaRepository(string connectionString)
        {
        ...
        private static void Ejecutar(NpgsqlConnection conn, string sql)
        {
        ...
        private static Cita LeerFila(NpgsqlDataReader r) => new Cita
        {
            Id = r.GetInt32(0),
